/**
 * Customer order types — Pradnyasanskar
 *
 * IMPORTANT:
 * Orders are owned by the Spring Boot backend.
 *
 * This file is for CUSTOMER-SIDE order data only.
 *
 * Do NOT:
 * - use localStorage for orders
 * - import admin order types
 * - import Product[] as order items
 * - add admin-specific types here
 */
...
/**
 * Mirrors Spring Boot OrderResponseDTO.
 *
 * This is the order representation returned to the customer frontend.
 */
export type Order = {
  orderId: number;
  orderNumber: string;
  ...
  /**
   * Backend sends this amount in RUPEES.
   */
  amount: number | null;
  ...
  /**
   * Additional backend status if present.
   */
  status: string | null;
};
...
// // // Demo seed — only available in development so production users never see fake orders
// // // export const DEMO_ORDERS: Order[] = process.env.NODE_ENV === "development" ? [
// // //   {
// // //     id: "PS-DEMO-0001",
...
//  *
//  * IMPORTANT:
//  * Orders are owned by the backend.
...
// /**
//  * Shared order types for Pradnyasanskar.
//  *
//  * These types mirror the Spring Boot OrderResponseDTO
//  * and OrderItemResponseDTO.
//  *
//  * IMPORTANT:
//  * Orders are stored in the backend/database.
//  * Do NOT use localStorage for orders.
//  */
...
// /**
//  * These must match the values of your backend OrderStatus enum.
//  *
//  * If your Java enum uses different values, update this union to match it.
//  */
// export type OrderStatus =
//   | "CONFIRMED"
//   | "PREPARING"
...
// /**
//  * Exact frontend representation of OrderResponseDTO.
//  */
// export type Order = {
//   orderId: number;
...
//   /**
//    * Backend sends amount in RUPEES according to your DTO comment.
//    */
//   amount: number | null;
...
// /**
//  * Alias used specifically by the admin section.
//  */

...
import { submitContactEnquiry } from "@/lib/contactApi";
...
function ContactContent() {
  ...
  const showOrderNumber =
    ORDER_NUMBER_TOPICS.includes(
      form.topic
    );

  const showImage =
    IMAGE_TOPICS.includes(form.topic);
  ...
  async function handleSubmit(
    ...
    try {
     ...
     trackEnquirySubmission("contact", {
  topic: form.topic,
});
      ...
      <section className="border-b border-[#E9E3EE] bg-gradient-to-br from-[#F4EEFF] via-[#FFFDF7] to-[#FFF8EE] py-16 sm:py-20">
        <div className="container-page">
          <Reveal>
            ...
            <h1 className="section-heading mt-5 max-w-2xl">
              We're here to help.
            </h1>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_360px]">
          ...
          <Reveal>
            <div className="rounded-[28px] border border-[#E9E3EE] bg-white p-6 sm:p-10">
              ...
              <h2 className="text-[22px] font-extrabold tracking-[-.04em] text-[#2E0569]">
                Send a message
              </h2>
              ...
              {apiError && (
                <div className="mt-6 rounded-[14px] border border-red-200 bg-red-50 px-4 py-3 text-[13px] font-semibold text-red-600">
                  {apiError}
                </div>
              )}
            ...
            <div className="space-y-4 lg:sticky lg:top-28">
              ...
              {[
                {
                  ...
                  label: "Email",
                  value:
                    "support@pradnyasanskar.com",
                  sub:
                    "We respond within 1–2 working days",
                },
                {
                  icon: Phone,
                  label: "Phone",
                ...
                },
                {
                  ...
                  value: "India",
                  sub:
                    "Domestic orders and enquiries only",
                },
              ].map(
                ({
                  icon: Icon,
                  ...
                  <div
                    key={label}
                    className="flex items-start gap-4 rounded-[20px] border border-[#E9E3EE] bg-white p-5"
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-[14px] font-extrabold text-[#2E0569]">
                        {value}
                      </p>
              ...
              <div className="rounded-[20px] bg-gradient-to-br from-[#F4EEFF] to-[#EDE4FF] p-5">
                ...
                <p className="mt-2 text-[13px] leading-relaxed text-[#5F5765]">
                  For distributor, bulk,
                  private-label or
                  manufacturing enquiries,
                  use our dedicated B2B
                  form.
                </p>

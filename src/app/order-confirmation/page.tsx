...
//         const realOrder = orders.find(
//           (item) =>
//             !item.id.startsWith("PS-DEMO"),
//         );
...
//                           />
//                         ) : (
//                           <div className="grid h-full w-full place-items-center text-[10px] font-bold text-[#8C52FF]">
//                             Product
//                           </div>
//                         )}
//                       </div>
...
//                         <p className="text-[10px] font-extrabold uppercase tracking-[.1em] text-[#8C52FF]">
//                           {item.range}
//                         </p>

//                         <p className="mt-0.5 truncate text-[14px] font-extrabold text-[#2E0569]">
//                           {item.name}
//                         </p>
...
//                   {
//                     step: "1",
//                     text: "You will receive an order confirmation email within a few minutes.",
//                   },
//                   {
//                     step: "2",
//                     text: "Our team will prepare and pack your order within 1–2 working days.",
//                   },
//                   {
//                     step: "3",
//                     text: "Once dispatched, you will receive a shipping confirmation with tracking details.",
//                   },
//                   {
//                     step: "4",
//                     text: "Your order will be delivered to your address within the estimated delivery window.",
//                   },
//                 ].map(({ step, text }) => (
//                   <div
//                     key={step}
...
//                   >
//                     <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#F2EBFF] text-[11px] font-extrabold text-[#8C52FF]">
//                       {step}
//                     </span>

//                     <p className="text-[13px] leading-relaxed text-[#716A78]">
//                       {text}
//                     </p>
//                   </div>
//                 ))}
...
// //         trackPurchase(
// //           newOrder.id,
// //           (pending.items ?? []).map((p: { id: string; name: string; range: string; format?: string; price: number }) => ({
// //             id: p.id, name: p.name, range: p.range, format: p.format, price: p.price ?? 0,
// //           })),
// //           pending.total ?? 0,
// //           pending.gst ?? 0,
// //           pending.shipping ?? 0,
// //           pending.couponApplied ? "WELCOME10" : undefined,
// //         );
// //         return;
// //       }
// //     } catch {}
